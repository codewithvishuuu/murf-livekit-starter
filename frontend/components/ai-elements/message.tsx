...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      'flex w-fit max-w-full min-w-0 flex-col gap-2 overflow-hidden text-sm leading-6',
      'group-[.is-user]:ml-auto group-[.is-user]:min-w-[3.25rem] group-[.is-user]:rounded-[16px] group-[.is-user]:rounded-br-[6px] group-[.is-user]:border group-[.is-user]:border-emerald-500/15 group-[.is-user]:bg-emerald-500/10 group-[.is-user]:px-3.5 group-[.is-user]:py-2.5 group-[.is-user]:text-emerald-950 dark:group-[.is-user]:bg-emerald-500/15 dark:group-[.is-user]:text-emerald-50',
      'group-[.is-assistant]:border-border/70 group-[.is-assistant]:bg-card group-[.is-assistant]:text-foreground group-[.is-assistant]:rounded-[16px] group-[.is-assistant]:rounded-bl-[6px] group-[.is-assistant]:border group-[.is-assistant]:px-4 group-[.is-assistant]:py-2.5',
      className
    )}
    {...props}
  >
